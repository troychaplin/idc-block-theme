<?php
/**
 * Title: Homepage Layout (FR)
 * Slug: idocs-block-theme/layouts-homepage-fr
 ...
 */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Hero Homepage","categories":["idocs-sections-fr"],"patternName":"idocs-block-theme/hero-homepage-fr"},"align":"full","className":"is-style-hero-blue is-hero is-hero\u002d\u002dhomepage","layout":{"type":"constrained"}} -->
...
<p class="has-text-align-left has-thin-lines has-thin-lines--blue has-thin-lines--right"><strong>Apostille et authentification de documents</strong></p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading has-text-align-left has-gray-400-color has-text-color has-link-color has-white-color has-heading-hero-font-size" style="font-style:normal;font-weight:400">Votre voie vers la<br><em><em><em><mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-primary-pale-color">Reconnaissance internationale</mark></em></em></em></h1>
<!-- /wp:heading --></header>
<!-- /wp:group -->

<!-- wp:paragraph -->
<p>De l'apostille à l'attestation, nous assurons la reconnaissance internationale de vos documents. En tant que partenaire canadien de confiance, nous prenons en charge l'ensemble du processus — légalisation, traduction et notarisation — avec l'expertise nécessaire pour que vos documents aient l'impact voulu, partout dans le monde.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>Notre équipe réactive offre des consultations gratuites et des conseils d'experts adaptés à chaque situation. Nous allons au-delà des attentes pour répondre à vos questions et garantir le traitement réussi de vos documents.</p>
...
<!-- wp:group {"tagName":"section","metadata":{"name":"Three Simple Steps","categories":["idocs-sections-fr"],"patternName":"idocs-block-theme/three-simple-steps-fr"},"align":"full","className":"is-style-beige","layout":{"type":"constrained"}} -->
...
<h2 class="wp-block-heading has-text-align-center has-gray-400-color has-text-color has-link-color has-grey-dark-color" style="font-style:normal;font-weight:400">Trois étapes simples<br><em><mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-primary-light-color"><em>Sans incertitude</em></mark></em></h2>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-x-large-font-size">Parlez-nous</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Laissez-nous vous aider à rassembler et préparer les documents requis pour une utilisation internationale. Quelle que soit votre situation, nous sommes prêts à vous accompagner vers la réussite.</p>
<!-- /wp:paragraph --></article>
<!-- /wp:group -->
...
<!-- wp:heading {"fontSize":"x-large"} -->
<h2 class="wp-block-heading has-x-large-font-size">Envoyez vos documents</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Envoyez vos documents à notre bureau pour un service sûr et fiable. Nous prendrons en charge toutes les étapes nécessaires et veillerons à ce que vos documents soient traités correctement.</p>
<!-- /wp:paragraph --></article>
<!-- /wp:group -->
...
<!-- wp:heading {"fontSize":"x-large"} -->
<h2 class="wp-block-heading has-x-large-font-size">Faites confiance aux experts</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"small"} -->
<p class="has-small-font-size">Vous pouvez maintenant vous détendre et faire confiance aux experts pour s’occuper du processus. Une fois vos documents finalisés, ils sont prêts à être utilisés partout dans le monde.</p>
<!-- /wp:paragraph --></article>
<!-- /wp:group --></div>
<!-- /wp:group -->
