...
<figure class="wp-block-image size-large has-custom-border is-style-rounded"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/Children-happy-Oct-9-2024-min-scaled-1-1024x644.jpg" alt="" class="has-border-color has-grey-light-border-color " style="border-width:1px;aspect-ratio:1;object-fit:cover"/></figure>
<!-- /wp:image -->
