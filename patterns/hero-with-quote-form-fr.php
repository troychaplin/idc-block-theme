<?php
/**
 * Title: Hero with Quote Form (FR)
 * Slug: idc-block-theme/hero-with-quote-form-fr
 * Categories: idc-sections-fr
 */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Hero with Quote Form","categories":["idc-sections-fr"]},"align":"full","className":"is-style-hero-beige is-hero","layout":{"type":"constrained"}} -->
