<?php
/**
 * Title: Recent Posts Beige (EN)
 * Slug: idc-block-theme/recent-posts-beige-en
 * Categories: idc-sections-en
 */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Recent Posts","categories":["idc-sections-en"]},"align":"full","className":"is-style-beige","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70"}}},"layout":{"type":"constrained"}} -->
