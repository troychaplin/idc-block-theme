...
<h2 class="wp-block-heading has-text-align-left has-gray-400-color has-text-color has-link-color has-grey-dark-color has-heading-large-font-size" style="font-style:normal;font-weight:400">What are<br><em><mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-primary-light-color"><em><em>Certified Translations?</em></em></mark></em></h2>
<!-- /wp:heading --></header>
<!-- /wp:group -->
...
<p class="has-medium-font-size">Certified translations are translations that have been done by a translator with the appropriate certification. A certified translator will translate the original document, stamp the translation with their seal, and add an affidavit to certify the translation.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"metadata":{"name":"Content Column"},"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size">In Canada, certification of translators is done at the provincial level, and each province has its own separate certification body.&nbsp;You may <a href="https://idc.local/idc-faq/how-do-i-find-an-appropriate-certified-translator/">find a translator</a> in your province by using the directory on the provincial certification website.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<h3 class="wp-block-heading has-text-align-left alignwide has-gray-400-color has-text-color has-link-color has-primary-light-color has-heading-medium-font-size" style="font-style:normal;font-weight:400"><em>Do I need to have my documents translated?</em></h3>
<!-- /wp:heading --></header>
<!-- /wp:group -->
