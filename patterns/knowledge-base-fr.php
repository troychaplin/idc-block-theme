<?php
/**
 * Title: Knowledge Base (FR)
 * Slug: idc-block-theme/knowledge-base-fr
 * Categories: idc-sections-fr
 */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Three Simple Steps","categories":["idc-sections-en"]},"align":"full","className":"is-style-beige","layout":{"type":"constrained"}} -->
