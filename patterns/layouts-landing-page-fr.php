<?php
/**
 * Title: Landing Page Layout (FR)
 * Slug: idc-block-theme/layouts-landing-page-fr
...
<h1 class="wp-block-heading has-text-align-left has-gray-400-color has-text-color has-link-color has-grey-dark-color has-heading-hero-font-size" style="font-style:normal;font-weight:400">Comment apostiller un<br><em><em><em><mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-primary-light-color">document canadien</mark></em></em></em></h1>
<!-- /wp:heading --></header>
<!-- /wp:group -->

<!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size">Le processus d’apostille au Canada demande une préparation minutieuse et une bonne compréhension des étapes à suivre. Avec les bons conseils, vous pouvez vous assurer que vos documents seront reconnus à l’international sans retard.</p>
<!-- /wp:paragraph -->
