<?php
/**
 * Title: Documents Layout (FR)
 * Slug: idc-block-theme/layouts-documents-fr
 ...
 */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Hero with Form","categories":["idc-sections-fr"],"patternName":"idc-block-theme/hero-with-form-fr"},"align":"full","className":"is-style-hero-beige is-hero","layout":{"type":"constrained"}} -->
...
<p class="has-text-align-left has-thin-lines has-thin-lines--right">Type de document</p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading has-text-align-left has-gray-400-color has-text-color has-link-color has-grey-dark-color has-heading-hero-font-size" style="font-style:normal;font-weight:400">Apostiller vos<br><em><em><em><mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-primary-light-color">Statuts Constitutifs</mark></em></em></em></h1>
<!-- /wp:heading --></header>
<!-- /wp:group -->

<!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size">Si vous souhaitez que les documents constitutifs de votre entreprise soient reconnus à l’étranger, vous aurez probablement besoin de vos statuts constitutifs apostillés. Cela garantit que vos documents corporatifs sont officiellement acceptés par les autorités d’un autre pays. Nos experts simplifient ce processus complexe et prennent en charge chaque étape pour vous, de la légalisation à l’apostille, avec rapidité et précision.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size">Contactez-nous pour discuter de vos documents et obtenir plus d’informations sur la procédure d’authentification et de légalisation.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:group {"tagName":"section","metadata":{"name":"About Our Services","categories":["idc-sections-fr"],"patternName":"idc-block-theme/apostille-made-simple-fr"},"align":"full","className":"is-style-white idc-section","layout":{"type":"constrained"}} -->
...
<div class="wp-block-group alignwide"><!-- wp:group {"tagName":"header","metadata":{"name":"Section Heading: Left","patternName":"core/block/39656"},"align":"wide","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|50"}}},"layout":{"type":"constrained","justifyContent":"left"}} -->
<header class="wp-block-group alignwide" style="margin-bottom:var(--wp--preset--spacing--50)"><!-- wp:paragraph {"className":"has-thin-lines has-thin-lines\u002d\u002dright","style":{"typography":{"textAlign":"left"}}} -->
<p class="has-text-align-left has-thin-lines has-thin-lines--right">L'apostille simplifiée</p>
<!-- /wp:paragraph -->
...
<p class="has-medium-font-size">Vos statuts peuvent nous être fournis pour le processus d'apostille. Si vos statuts vous ont été délivrés électroniquement, ces fichiers électroniques peuvent nous être fournis pour traitement. Les documents délivrés électroniquement sont éligibles à l'« e-apostille », ce qui signifie que nous pouvons imprimer, notarier, puis apostiller les documents.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"metadata":{"name":"Content Column"},"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size">Si vous disposez de documents d'incorporation physiques, vous pouvez les envoyer à notre bureau pour notarisation et apostille. Nous pouvons également vous assister avec des services supplémentaires, tels que la traduction. Contactez-nous pour discuter de vos besoins en matière de documents.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></section>
...
<!-- wp:group {"tagName":"section","metadata":{"name":"About the Process","categories":["idc-sections-fr"],"patternName":"idc-block-theme/about-the-process-2-col-fr"},"align":"full","className":"is-style-beige","layout":{"type":"constrained"}} -->
...
<h2 class="wp-block-heading has-text-align-center has-gray-400-color has-text-color has-link-color has-grey-dark-color" style="font-style:normal;font-weight:400">Apostille<br><em><mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-primary-light-color"><em>de documents</em></mark></em></h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-black-color has-text-color has-link-color has-medium-font-size" style="margin-top:var(--wp--preset--spacing--50);margin-bottom:var(--wp--preset--spacing--60)">Pour qu’un document soit reconnu à l’étranger, il doit passer par le processus d’apostille. Cela permet son acceptation dans les pays qui adhèrent à la Convention de La Haye. Pour ces destinations, le processus d’apostille s’applique et comprend les étapes suivantes :</p>
<!-- /wp:paragraph --></header>
<!-- /wp:group -->

<!-- wp:group {"metadata":{"name":"Card Grid: Numbered Cards"},"className":"is-card-grid is-card-grid\u002d\u002dtwo","style":{"spacing":{"blockGap":"0"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group is-card-grid is-card-grid--two"><!-- wp:group {"tagName":"article","metadata":{"name":"Card Item"},"className":"is-card","layout":{"type":"constrained"}} -->
...
<!-- wp:paragraph -->
<p><a href="https://idc.local/nos-services/apostille-de-documents/apostille-de-documents-canadiens/preparation-des-documents-pour-lapostille/?lang=fr" type="page" id="35317">Préparer vos documents</a></p>
...
<!-- wp:heading -->
<h2 class="wp-block-heading">Apostille du document</h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>L’apostille du document constitue l’étape finale du processus, permettant sa reconnaissance officielle dans un autre pays signataire de la Convention de La Haye.</p>
<!-- /wp:paragraph -->
...
<!-- wp:tidbits/tidbit -->
<div class="wp-block-tidbits-tidbit"><!-- wp:tidbits/morsel {"postId":494} /-->

<!-- wp:tidbits/morsel {"postId":494} /-->

<!-- wp:tidbits/morsel {"postId":494} /--></div>
