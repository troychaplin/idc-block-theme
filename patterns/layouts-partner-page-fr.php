<?php
/**
 * Title: Partner Page Layout (FR)
 * Slug: idc-block-theme/layouts-partner-page-fr
...
<p class="has-text-align-left has-thin-lines has-thin-lines--right">Nos partenaires</p>
<!-- /wp:paragraph -->
...
<h1 class="wp-block-heading has-text-align-left has-gray-400-color has-text-color has-link-color has-grey-dark-color has-heading-hero-font-size" style="font-style:normal;font-weight:400">Align Abroad<br><em><em><em><mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-primary-light-color">Consulting Services</mark></em></em></em></h1>
<!-- /wp:heading --></header>
<!-- /wp:group -->

<!-- wp:heading {"style":{"elements":{"link":{"color":{"text":"var:preset|color|black"}}}},"textColor":"black","fontSize":"heading-small"} -->
<h2 class="wp-block-heading has-black-color has-text-color has-link-color has-heading-small-font-size">Pour des documents reconnus à l’international</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size">Align Abroad Consulting Services et International Documents Canada (IDC) sont fiers d’offrir un partenariat de confiance en services d’apostille pour répondre à vos besoins en matière de documents internationaux. Que vous ayez à certifier des documents personnels, corporatifs ou juridiques pour une utilisation à l’étranger, notre équipe d’experts est là pour vous aider — en rendant le processus plus rapide, plus clair et sans tracas.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group alignwide"><!-- wp:group {"metadata":{"name":"Image"},"align":"wide","className":"is-style-default","style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50","left":"var:preset|spacing|40","right":"var:preset|spacing|40"},"margin":{"bottom":"var:preset|spacing|60"}},"border":{"radius":{"topLeft":"4px","topRight":"4px","bottomLeft":"4px","bottomRight":"4px"},"width":"1px"}},"gradient":"custom-secondary-pale-fade-in","borderColor":"secondary-light","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignwide is-style-default has-border-color has-secondary-light-border-color has-custom-secondary-pale-fade-in-gradient-background has-background" style="border-width:1px;border-top-left-radius:4px;border-top-right-radius:4px;border-bottom-left-radius:4px;border-bottom-right-radius:4px;margin-bottom:var(--wp--preset--spacing--60);padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40)"><!-- wp:image {"id":36645,"width":"220px","sizeSlug":"medium","linkDestination":"none","align":"center"} -->
<figure class="wp-block-image aligncenter size-medium is-resized"><img src="https://idc.local/wp-content/uploads/AlignAbroad1-Logo-002-1024x572.png" alt="Align Abroad Consulting Services logo" class="wp-image-36645" style="width:220px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<h2 class="wp-block-heading has-heading-medium-font-size">Un fier partenaire de Align Abroad Consulting Services</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size">Nous sommes fiers qu’Align Abroad Consulting Services ait choisi International Documents Canada (IDC) comme partenaire pour le processus d’apostille de documents. En tant que principal fournisseur de services d’apostille au Canada et aux États-Unis, nos experts peuvent gérer toutes les étapes du processus à votre place, vous évitant des erreurs coûteuses, de la frustration et des semaines d’attente.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size">Mais surtout, nous prendrons le temps de répondre à vos questions et de vous fournir les renseignements dont vous avez besoin, sans frais et sans engagement.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"metadata":{"name":"Content Column"},"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:heading {"fontSize":"heading-medium"} -->
<h2 class="wp-block-heading has-heading-medium-font-size">À propos de l’apostille de documents</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size">Une apostille est une certification officielle qui confirme l’authenticité d’un document afin qu’il soit reconnu dans d’autres pays signataires de la Convention de La Haye. Tout pays signataire émet des certificats d’apostille et accepte ceux émis par les autres pays membres.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p>Le processus d’apostille permet de certifier vos documents pour qu’ils soient acceptés à l’étranger. Il est souvent requis pour des documents tels que les actes immobiliers, documents d’entreprise, certificats d’état civil ou vérifications de casier judiciaire.</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size">Align Abroad Consulting Services s’est associé à International Documents Canada (IDC) pour vous fournir l’information et l’assistance d’experts dans ce processus souvent complexe.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></section>
...
<!-- wp:paragraph -->
<p>Nous avons développé une collection riche et en constante croissance d’articles informatifs sur le processus d’apostille et nos services. <a href="https://idc.local/informations-services-apostille-canada/articles-apostille-processus-canada/?lang=fr" type="page" id="34173">Read more articles</a></p>
<!-- /wp:paragraph --></article>
<!-- /wp:group -->
