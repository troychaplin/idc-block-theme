<?php
/**
 * Title: Complete Solution Form (EN)
 * Slug: idc-block-theme/complete-solution-form-en
 * Categories: idc-sections-en
 */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Complete Solution Form","categories":["idc-sections-en"]},"align":"full","className":"is-style-white","layout":{"type":"constrained"}} -->
